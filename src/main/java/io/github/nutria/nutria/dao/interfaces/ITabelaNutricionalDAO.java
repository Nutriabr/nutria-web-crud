...
public interface ITabelaNutricionalDAO {
    ...
    /**
     * Filtra os registros da tabela nutricional de acordo com um filtro pré-definido.
     * <br>
     ...
     * @return retorna uma lista de objetos {@link TabelaNutricional} que atendem aos critérios do filtro.
    ...
    /** Filtra os registros da tabela nutricional com base em um valor mínimo, máximo ou intervalo
