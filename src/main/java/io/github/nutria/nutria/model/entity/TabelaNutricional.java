...
public class TabelaNutricional {
    ...
    public void setCarboidratosG(double carboidratosG) { this.carboidratosG = carboidratosG; }

    public double getAcucaresTotaisG() { return acucaresTotaisG; }
    public void setAcucaresTotaisG(double acucaresTotaisG) { this.acucaresTotaisG = acucaresTotaisG; }

    public double getAcucaresAdicionadosG() { return acucaresAdicionadosG; }
    public void setAcucaresAdicionadosG(double acucaresAdicionadosG) { this.acucaresAdicionadosG = acucaresAdicionadosG; }
    ...
    public void setGordurasTotaisG(double gordurasTotaisG) { this.gordurasTotaisG = gordurasTotaisG; }

    public double getGordurasSaturadasG() { return gordurasSaturadasG; }
    public void setGordurasSaturadasG(double gordurasSaturadasG) { this.gordurasSaturadasG = gordurasSaturadasG; }

    public double getGordurasTransG() { return gordurasTransG; }
    public void setGordurasTransG(double gordurasTransG) { this.gordurasTransG = gordurasTransG; }

    public double getFibraAlimentarG() { return fibraAlimentarG; }
    public void setFibraAlimentarG(double fibraAlimentarG) { this.fibraAlimentarG = fibraAlimentarG; }

    public double getSodioMg() { return sodioMg; }
    public void setSodioMg(double sodioMg) { this.sodioMg = sodioMg; }

    public double getColesterolMg() { return colesterolMg; }
    public void setColesterolMg(double colesterolMg) { this.colesterolMg = colesterolMg; }

    public double getVitaminaAMcg() { return vitaminaAMcg; }
    public void setVitaminaAMcg(double vitaminaAMcg) { this.vitaminaAMcg = vitaminaAMcg; }
    ...
    public double getVitaminaDMcg() { return vitaminaDMcg; }
    public void setVitaminaDMcg(double vitaminaDMcg) { this.vitaminaDMcg = vitaminaDMcg; }

    public double getCalcioMg() { return calcioMg; }
    public void setCalcioMg(double calcioMg) { this.calcioMg = calcioMg; }

    public double getFerroMg() { return ferroMg; }
    public void setFerroMg(double ferroMg) { this.ferroMg = ferroMg; }

    public double getPotassioMg() { return potassioMg; }
    public void setPotassioMg(double potassioMg) { this.potassioMg = potassioMg; }
