...
<div class="sidebar">
    ...
    <ul class="menu">
        ...
        <li class="<% if ("tabelaNutricional".equals(activePage)) {out.print("active"); } %>"><i class="fa-solid fa-list"></i><a href="${pageContext.request.contextPath}/tabelaNutricional/listar"> Tabelas Nutricionais</a></li>
        ...
        <li class="<% if ("receitaIngrediente".equals(activePage)) {out.print("active"); } %>"><i class="fa-solid fa-clipboard-list"></i><a href="${pageContext.request.contextPath}/receitasIngredientes/listar"> Ingredientes da Receita</a></li>
        <li class="<% if ("analytics".equals(activePage)) {out.print("active"); } %>"><i class="fa-solid fa-chart-column"></i><a href="https://app.powerbi.com/view?r=eyJrIjoiZGYyZWI3MmMtOTBhYS00ZjFjLWJiYTYtNGIwY2RmZTMyZmE5IiwidCI6ImIxNDhmMTRjLTIzOTctNDAyYy1hYjZhLTFiNDcxMTE3N2FjMCJ9" target="_blank">Analytics</a></li>    </ul>
