            ...
            <header class="table-header">
                ...
                <div class="table-actions">
                    <form action="${pageContext.request.contextPath}/produto/listar" method="get" class="search-bar">
                        ...
                        <input type="search" name="busca" placeholder="Buscar pelo nome ou ID"
            ...
            <div class="delete-popup" style="display: none">
                ...
                <div class="delete-popup-content">
                    <select name="opcao" id="selectOpcao">
                        ...
                        <option value="<%= emailsList.get(i)%>" id="email-opcao"><%= emailsList.get(i)%></option>
                        <% } %>
                    </select>

                    <form action="${pageContext.request.contextPath}/produto/excluir" method="post">
                        <input type="hidden" name="acao" value="deletarPorEmail">
                        <button type="submit" class="btn-action deletar-por-opcao">Deletar todos os registros</button>
                    </form>
                </div>
            </div>
            ...
            <div class="table-container">
                <table>
                    ...
                    <tr>
                        ...
                        <td><%= produto.getIdUsuario() %>
                        </td>
                        <td><%= produto.getNomeUsuario()%>
                        </td>
                        <td><%= produto.getEmailUsuario()%>
                        </td>
                        <td><%= produto.getEmpresaUsuario()%>
                        </td>
                        <td class="action-buttons">
                            <a href="${pageContext.request.contextPath}/produto/editar?id=<%= produto.getId() %>"
...
<div class="overlay" id="delete-all-popup-overlay" style="display: none;">
    <div class="popup-container">
        ...
        <p>Você não poderá recuperar nenhum registro do usuário <strong id="opcao-nome"></strong> após excluir.</p>
        <div class="popup-actions">
            <button class="btn btn-secondary" id="cancel-delete-all-btn">Cancelar</button>
            <form id="delete-all-form" action="${pageContext.request.contextPath}/produto/excluir" method="post">
